<template>
  <div class="view-container">
    <div class="image">
      <el-image :src="BRAND_PDF" :fit="true" :lazy="true">
        <template #error>
    ...
    <FilePreview v-if="isPreview" :url="previewFile.url" @close="closePreviewBox" />
  </div>
</template>
<script lang="ts">
...
import BRAND_PDF from '@/assets/media/brand-pdf.png'
...
export default defineComponent({
  ...
  setup(props, { attrs, slots, emit }) {
    ...
    /** props start */
    const { file, fileList, canUpload, canDownload, action, canMultiple, limit, isAutoUpload, headers, data, name, accept, showFileList } = props
    /** props end */
    /** data start */
