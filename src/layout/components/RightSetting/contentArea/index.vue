<template>
  <el-form ref="contentFormRef" :model="colors" label-position="left" class="content-form" label-width="100px">
    <el-form-item :label="langConfig.form.headerArea[lang]" prop="primary">
      <el-switch v-model="showHeader" active-color="#13ce66" inactive-color="#ff4949" @change="handleChange">
      </el-switch>
    </el-form-item>
    <el-form-item :label="langConfig.form.sidebarLogo[lang]" prop="primary">
      <el-switch v-model="sidebarLogo" active-color="#13ce66" inactive-color="#ff4949"
        @change="handleSidebarLogoChange"> </el-switch>
    </el-form-item>
    <el-form-item :label="langConfig.form.headerFixed[lang]" prop="primary">
      <el-switch v-model="fixedHeader" active-color="#13ce66" inactive-color="#ff4949" @change="handleFixedChange">
      </el-switch>
    </el-form-item>
  </el-form>
</template>
