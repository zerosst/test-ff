<template>
  <section class="app-main">
    <el-tabs style="background:#fff;" id="Tabs" v-model="currentIndex" type="card" closable @tab-click="clickTab"
      @tab-remove="removeTab">
      <el-tab-pane v-for="item in tabsOption" :key="item.route" :closable="item.route !== '/home'" :label="item.title"
...
export default defineComponent({
  ...
  setup() {
    ...
    const currentIndex = computed({
      get: () => store.getters['tabModule/getCurrentIndex'],
      set: () => {
